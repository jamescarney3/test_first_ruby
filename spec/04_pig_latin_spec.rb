...
describe "#translate" do
  ...
  it "preserves capitalization of words" do
    s = translate("Apple pear apple Pear")
    s.should == "Appleay earpay appleay Earpay"
  end
  
  it "preserves punctuation from the original phrase" do
    s = translate("Here's a sample string; it includes punctuation.")
    s.should == "Ere'shay aay amplesay ingstray; itay includesay unctuationpay."
  end
